                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <input maxlength="50" id="ip" name="ip" value="<?php echo htmlentities((isset($data['IP']) && ($data['IP'] !== '')?$data['IP']:'')); ?>"
                                       class="form-control" placeholder="请输入IP">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <input maxlength="50" id="website" name="website" value="<?php echo htmlentities((isset($data['website']) && ($data['website'] !== '')?$data['website']:'')); ?>"
                                       class="form-control" placeholder="请输入website">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <input maxlength="50" id="other" name="other" value="<?php echo htmlentities((isset($data['other']) && ($data['other'] !== '')?$data['other']:'')); ?>"
                                       class="form-control" placeholder="请输入other">
                            </div>
                        </div>
