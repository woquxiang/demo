            ...
            <div class="box">
                <div class="box-body">
                    <form class="form-inline searchForm" id="searchForm" action="<?php echo url('index'); ?>" method="GET">
                        ...
                        <div class="form-group">
                            <input readonly value="<?php echo isset($create_time) ? htmlentities($create_time) : '' ;; ?>"
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities($item->adminUser->nickname); ?></td>
                            <td><?php echo htmlentities($item['name']); ?></td>
                            <td><?php echo htmlentities($item['url']); ?></td>
                            <td><?php echo htmlentities($item['log_method']); ?></td>
                            <td><?php echo htmlentities($item['log_ip']); ?></td>
                            <td><?php echo htmlentities($item['create_time']); ?></td>
                            <td class="td-do">
                                <a data-id="<?php echo htmlentities($item['id']); ?>" data-url="view" data-confirm="2" data-type="2"
