        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header">
                    <div>
                        ...
                        <a class="btn btn-success btn-sm ReloadButton" data-toggle="tooltip" title="刷新"
                           data-id="checked" data-url="<?php echo url('del'); ?>">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="td-do">
                                <a href="<?php echo url('admin_role/access',['id'=>$item['id']]); ?>"
                                   class="btn btn-warning btn-xs" data-toggle="tooltip" title="授权">
                                    <i class="fa fa-key"></i>
                                </a>

                                <a href="<?php echo url('admin_role/edit',['id'=>$item['id']]); ?>"
                ...
                <div class="box-footer">
                    <?php echo $page; ?>
                    <label class="control-label pull-right pageControl" style="margin-right: 10px; font-weight: 100;">
