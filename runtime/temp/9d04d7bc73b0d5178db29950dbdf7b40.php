                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities($item['module']); ?></td>
                            <td><?php echo htmlentities($item['code']); ?></td>
                            <td><?php echo htmlentities($item['sort_number']); ?></td>
                            <td><?php echo htmlentities($item['auto_create_menu_text']); ?></td>
                            <td><?php echo htmlentities($item['auto_create_file_text']); ?></td>
                            ...
                            <td class="td-do">
                                ...
                                <a class="btn btn-success btn-xs AjaxButton" data-toggle="tooltip" title="生成配置文件"
                                   data-id="<?php echo htmlentities($item['id']); ?>" data-confirm-title="生成配置文件确认"
                                   data-confirm-content='您确定要生成ID为 <span class="text-red"><?php echo htmlentities($item['id']); ?></span> 的配置文件吗'
                                   data-url="<?php echo url('file'); ?>">
                                    <i class="fa fa-file-code-o"></i>
                                </a>

                                <a class="btn btn-warning btn-xs AjaxButton" data-toggle="tooltip" title="生成菜单"
                                   data-id="<?php echo htmlentities($item['id']); ?>" data-confirm-title="生成菜单确认"
                                   data-confirm-content='您确定要生成ID为 <span class="text-red"><?php echo htmlentities($item['id']); ?></span> 的菜单吗'
                                   data-url="<?php echo url('menu'); ?>">
