                    ...
                    <form class="form-inline searchForm" id="searchForm" action="<?php echo url('index'); ?>" method="GET">
                        ...
                        <div class="form-group">
                            <select name="user_level_id" id="user_level_id" class="form-control input-sm index-search">
                                ...
                                <?php if(is_array($user_level_list) || $user_level_list instanceof \think\Collection || $user_level_list instanceof \think\Paginator): if( count($user_level_list)==0 ) : echo "" ;else: foreach($user_level_list as $key=>$item): ?>
                                <option value="<?php echo htmlentities($item['id']); ?>" <?php if(isset($user_level_id) &&''!==$user_level_id && $user_level_id==$item['id']): ?>selected<?php endif; ?>><?php echo htmlentities($item['name']); ?></option>
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tbody>
                        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $data_key=>$item): ?>
                        <tr>
                            <td>
                            ...
                            <td><img class="dataListImg" src="<?php echo htmlentities($item['avatar']); ?>"></td>
                            ...
                            <td><?php echo htmlentities((isset($item['user_level']['name']) && ($item['user_level']['name'] !== '')?$item['user_level']['name']:'')); ?></td>
                            <td><?php echo htmlentities($item['status_text']); ?></td>
                            <td><?php echo htmlentities($item['create_time']); ?></td>

                            <td class="td-do">
                                <a href="<?php echo url('edit',['id'=>$item['id']]); ?>"
                                ...
                                <a class="btn btn-danger btn-xs AjaxButton" data-toggle="tooltip" title="删除"
                                   data-id="<?php echo htmlentities($item['id']); ?>" data-confirm-title="删除确认"
                                   data-confirm-content='您确定要删除ID为 <span class="text-red"><?php echo htmlentities($item['id']); ?></span> 的数据吗'
                                   data-url="<?php echo url('del'); ?>">
