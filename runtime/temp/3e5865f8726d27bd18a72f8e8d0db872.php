    ...
    <div class="row">
        <div class="pad margin no-print">
            <div class="callout callout-info">
                <h4><i class="fa fa-info"></i> 您好,<?php echo htmlentities((isset($user['nickname']) && ($user['nickname'] !== '')?$user['nickname']:'管理员')); ?>:</h4>
                <?php echo htmlentities((isset($notice_content) && ($notice_content !== '')?$notice_content:'')); ?>
            </div>
        </div>
    </div>
    <?php endif; ?>
