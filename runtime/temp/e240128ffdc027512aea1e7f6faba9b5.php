                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlentities((isset($item['setting_group']['name']) && ($item['setting_group']['name'] !== '')?$item['setting_group']['name']:'')); ?></td>
